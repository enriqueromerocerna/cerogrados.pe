  ...
  for (let i = 1; i <= n; i++) {
    ...
    html += `
      <div class="unit-block" data-tipo="raspadilla" data-index="${i}">
        ...
        ${mostrarNombre ? `<input type="text" class="unit-name" data-role="nombre" placeholder="Nombre de quien se la come">` : ''}
  ...
  for (let i = 1; i <= n; i++) {
    ...
    html += `
      <div class="unit-block" data-tipo="marciano" data-index="${i}">
        ...
        ${mostrarNombre ? `<input type="text" class="unit-name" data-role="nombre" placeholder="Nombre de quien se lo come">` : ''}
